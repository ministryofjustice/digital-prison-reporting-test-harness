...
# MOVEMENT_REASONS
    ...
    MOVEMENT_REASON_CODE_CHOICES = ["26", "CONR", "CRT", "DCYP", "LICR", "MED", "V", "W", "F4", "PDH", "PS", "TRIAL", "VLBH", "VLCH", "VLNH", "VLWT", "99", "AS", "D1", "DEC", "ER", "REL", "1", "C4", "C5", "F1", "LTX", "R4", "ADMIN", "PRES", "PROG", "ADMN", "CCOM", "DHMP", "H", "R", "TRN", "TRNTAP", "U", "CA", "CONF", "PR", "REM", "VLCV", "VLPR", "AV", "D5", "NCS", "NG", "RE", "UAL_ECL", "13", "17", "3", "C2", "C7", "PAP", "R5", "R7", "RESET", "SP", "28", "RECAT", "FINE", "P", "COM", "INTAKE", "VLEB", "AR", "D6", "DA", "DD", "ESCP", "EX", "HD", "NP", "PD", "PF", "11", "12", "18", "21", "6", "ACCVISIT", "C1", "EL", "F9", "FR", "I1", "IM", "YOTR", "29", "CLIF", "ELR", "I", "K", "PSUS", "19", "22", "BREACH", "CRI", "NA", "NEWTON", "VLAP", "VLCR", "VLPP", "VLPS", "VLRH", "D3", "DS", "ETR", "HR", "16",
                                    "20", "FA", "YRDR", "PROD", "25", "D", "IMMIG", "M", "PSYC", "Q", "RHDC", "TRNCRT", "Y", "CAP", "VLBL", "BL", "DL", "HU", "IF", "MRG", "10", "8", "F2", "F3", "F8", "FAC", "FD", "SE", "APPEALS", "SEC", "A", "B", "C", "FOREIGN", "HLF", "J", "RDTO", "RECA", "SENT", "T", "AP", "DC", "SEN", "VL", "VLPC", "VLPD", "CE", "D2", "DE", "PX", "SC", "WEND", "14", "15", "5", "7", "C6", "DENT", "FE", "FF", "OPA", "R2", "R9", "RO", "TAP", "UPW", "24", "27", "JAIL", "N", "O", "RMND", "YDET", "Z", "APPEAR", "AU", "CT", "DIR", "BD", "D4", "HE", "9", "C3", "FB", "HOSP", "PC", "R3", "YMI", "AVIST", "NOTR", "OTHER", "PROAT", "E", "ETB", "F", "G", "INT", "INTER", "L", "S", "BAIL", "CR", "DISC", "HC", "HP", "RW", "UAL", "2", "4", "C9", "COMP", "ET", "F6", "F7", "FC", "IR", "PWP", "R1", "R6", "R8", "OJ", "OVCROW"]
...
# Render the template with the variables
    AGENCY_LOCATIONS = template.render(AGY_LOC_ID=AGY_LOC_ID, DESCRIPTION=DESCRIPTION,
                                       DISTRICT_CODE=DISTRICT_CODE, AUDIT_USER_ID=AUDIT_USER_ID, timestamp=metadata_timestamp_current)
    ...
    AGENCY_INTERNAL_LOCATIONS = template.render(INTERNAL_LOCATION_ID=INTERNAL_LOCATION_ID, DESCRIPTION=DESCRIPTION,
                                                AUDIT_CLIENT_USER_ID=AUDIT_CLIENT_USER_ID, AUDIT_USER_ID=AUDIT_USER_ID, timestamp=metadata_timestamp_current)
